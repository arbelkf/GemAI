# Auther : Kfir Arbel
# date : 6.8.2018
# PercentForPeriodIndexCorrRollingStrategy Class
...
class PercentForPeriodIndexCorrRollingStrategy(AbstractPercentForPeriodStrategy):
    ...
    def ExtractLabels(self, dfdata):
        ...
        dfdata['adj close'] = dfdata['adj close'].rolling(window=5).mean()
